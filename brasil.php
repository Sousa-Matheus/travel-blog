...
$query_rs_brasil = "SELECT cod_pag, titulo, descricao, img1_p FROM tb_blog_lh WHERE cod_pais = 2";
$rs_brasil = mysql_query($query_rs_brasil, $con_lesshome) or die(mysql_error());
$row_rs_brasil = mysql_fetch_assoc($rs_brasil);
$totalRows_rs_brasil = mysql_num_rows($rs_brasil);
?>
<?php
...
<?php do { ?>
  <div class="col-lg-4"><p><strong><?php echo $row_rs_brasil['titulo']; ?></strong></p>
  <p><img src="<?php echo $row_rs_brasil['img1_p']; ?>" class="img-fluid"> <?php echo $row_rs_brasil['descricao']; ?><a href="post.php?cod_pag=<?php echo $row_rs_brasil['cod_pag']?>">Saber Mais...</a></p>
  </div>
  <hr>
  <?php } while ($row_rs_brasil = mysql_fetch_assoc($rs_brasil)); ?>
		</div>
</section>
</div>
